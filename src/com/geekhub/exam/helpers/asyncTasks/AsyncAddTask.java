...
public class AsyncAddTask extends CommonAsyncTask {
	...
	AsyncAddTask(MainActivity activity, ProgressBar progress,
			AddTaskCallBack callBack, String taskListID, Task task) {
	...
	public static void run(MainActivity tasksSample, ProgressBar progress,
			AddTaskCallBack callBack, String taskListID, Task task) {
		new AsyncAddTask(tasksSample, progress, callBack, taskListID, task)
				.execute();
	}
